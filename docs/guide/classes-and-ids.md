...
This is the most common syntax in Resumx — used for applying [Tailwind CSS](/guide/tailwind-css) classes, tagging content for [tailored variants](/guide/tags), and more:
